...
import { AcceptBtn, CloseDiv,Container, InfoP, VerifyCont } from './Agreement.styles';
...
const Agreement = () => {
	...
	return (
		<>
			<VerifyCont>
				{next ? (
					<Title>Умови та правила участі на проєкті</Title>
				) : (
					<Title>Згода на обробку персональних даних</Title>
				)}
				<Container>
					<ol>
						<li>
							<InfoP>
								1. Навчальний проект- платформа Baza Trainee Ukraine надає можливість кожному, хто хоче набути практики
								в ІТ діяльності, взяти участь в створенні реальних проектів для соціальної сфери (благодійних фондів,
								громадських організацій тощо).
							</InfoP>
						</li>
						<li>
							<InfoP>
								2. Платформу створено перш за все для розробників-початківців, джуніорів, світчерів. Також ми запрошуємо
								до співпраці менторів, які можуть допомогти команді на будь-якому етапі створення проекту. Ми також
								відкриті партнерству з компаніями, де ми можемо бути корисні один одному.
							</InfoP>
						</li>
						<li>
							<InfoP>
