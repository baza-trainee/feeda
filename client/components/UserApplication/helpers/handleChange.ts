// import { discordRegex, emailRegex, linkedRegex, phoneNumberRegex } from './index';
...
// export const onHandleDiscordChange: FieldChangeHandler = (fieldName, value, clearErrors) => {
